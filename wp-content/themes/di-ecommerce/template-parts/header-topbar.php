			...
			<div class="col-md-6">
				<p class="spsl-fr-topbar-icons iconouter">
					...
					if( get_theme_mod( 'display_sicons_top_bar', '1' ) == 1 ) {
						...
						?>
							<a title="<?php esc_attr_e( 'Google Plus', 'di-ecommerce' ); ?>" <?php echo $s_link_tab; ?> href="<?php echo esc_url( get_theme_mod( 'sprofile_link_googleplus' ) ); ?>"><span class="fa fa-google bgtoph-icon-clr"></span></a>
						<?php
						}
						?>
